...
void cargaDeFacturas(struct Facturas str[]){
  ...
  str[0].numeroDeProvincia = 2;
  str[0].numeroDeServicio = 20;
  str[0].montoDeFactura = 300;

  str[1].numeroDeFactura = 256;
  str[1].numeroDeProvincia = 1;
  str[1].numeroDeServicio = 7;
  str[1].montoDeFactura = 500;

  str[2].numeroDeFactura = 299;
  str[2].numeroDeProvincia = 2;
  str[2].numeroDeServicio = 7;
  str[2].montoDeFactura = 199;

  str[3].numeroDeFactura = 291;
  str[3].numeroDeProvincia = 0;
  str[3].numeroDeServicio = 20;
  str[3].montoDeFactura = 90;

  str[4].numeroDeFactura = 190;
  str[4].numeroDeProvincia = 2;
  str[4].numeroDeServicio = 9;
  str[4].montoDeFactura = 700;

  str[5].numeroDeFactura = 748;
  str[5].numeroDeProvincia = 1;
  str[5].numeroDeServicio = 7;
  str[5].montoDeFactura = 30;

  str[6].numeroDeFactura = 385;
  str[6].numeroDeProvincia = 0;
  str[6].numeroDeServicio = 1;
  str[6].montoDeFactura = 50;

  str[7].numeroDeFactura = 110;
  str[7].numeroDeProvincia = 0;
  str[7].numeroDeServicio = 7;
  str[7].montoDeFactura = 873;

  str[8].numeroDeFactura = 293;
  str[8].numeroDeProvincia = 2;
  str[8].numeroDeServicio = 20;
  str[8].montoDeFactura = 300;

  str[9].numeroDeFactura = 389;
  str[9].numeroDeProvincia = 1;
  str[9].numeroDeServicio = 7;
